...
from NaverCaptcha.utils.driverutils import DriverUtils
from NaverCaptcha.utils.winkeyboard import WinKeyboard
import time
...
class Naver(object):
    ...
    def clipboard_login(self, user_id, user_pw):
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath('//*[@id="frmNIDLogin"]/fieldset/span[2]/a').click()
